    ...
    <div className="min-h-screen">
      ...
      <section id="summary" className="relative pt-32 pb-20 px-6 overflow-hidden">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-6 tracking-tight">
            I optimize <span className="text-gradient">data infrastructure</span> for scale.
          </h1>
        ...
        >
          ...
          <div className="grid gap-8">
            {PORTFOLIO_DATA.education.map((edu, idx) => (
              <div key={idx} className="p-8 rounded-3xl glass-effect border border-slate-800">
      ...
      <section id="contact" className="py-24 px-6">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-8 z-10">Connect with me.</h2>
          <p className="max-w-xl text-indigo-100 text-lg mb-12 z-10">
            Based in India. Available for opportunities in Database Development and Cloud Engineering.
          </p>
          <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-6 z-10">
            <a href={`mailto:${PORTFOLIO_DATA.contact.email}`} className="px-8 py-4 bg-white text-indigo-600 rounded-2xl font-bold hover:scale-105 transition-transform flex items-center justify-center">
              Email Me
            </a>
            <div className="flex space-x-4">
              <a href={PORTFOLIO_DATA.contact.linkedin} target="_blank" rel="noopener noreferrer" className="w-14 h-14 bg-indigo-500 rounded-2xl flex items-center justify-center text-white hover:bg-indigo-400 transition-colors border border-indigo-400">
      ...
      <footer className="py-12 border-t border-slate-900">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center text-slate-500 text-sm">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            <p>Built for Recruiters • RA Portfolio</p>
          </div>
        </div>
      </footer>
